...
const ProductsDetails = () => {
  ...
  const handleUpdate = (e) => {
    ...
    const info = { productName, category, price, time, image, customization, rating, stock, description };
    // console.log(info);
      ...
      <div className="shadow-lg p-5 border rounded-lg bg-[#e0d5dc]">
        ...
        <div className="mt-5 mb-8">
          <p className="text-center text-3xl font-semibold">
            ...
            <span className="dark:text-white flex justify-center gap-2 text-red-400">
              Update Painting
            </span>
          </p>
        </div>
